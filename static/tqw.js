 ...
 * @constructor
 */
var TableQueryWrapper = function(query, container, options, viewTweak) {
...
TableQueryWrapper.prototype.handleResponse = function(response) {
  ...
  if (response.isError()) {
    ...
    if (this.viewTweaker) this.viewTweaker(this.currentDataView);
    this.table.draw(this.currentDataView, this.tableOptions);
  }
};
...
TableQueryWrapper.prototype.handleSort = function(properties) {
  ...
  var colID = this.currentDataView.getColumnId(columnIndex);
...
TableQueryWrapper.prototype.setPageQueryClause = function(pageIndex) {
  ...
  var dataTable = this.currentDataView;
